...
//	public ResponseEntity<List<ExamPartDTO>> getAllForCourseInstance(@PathVariable("courseId") Long idCourseInstance){
//		System.out.println("\nGet all parts for ADMINISTRATOR");
//		List<ExamPart> examParts = examPartServiceInterface.findByCourseInstance(idCourseInstance);
//		
//		List<ExamPartDTO> dtos = new ArrayList<ExamPartDTO>();
//		
//		for (ExamPart examPart : examParts) {
