...
//
//import ftn.eObrazovanjeProjekat.EObrazivanjeProjekat.dto.ExamPartStatusDTO;
...
//		List<ExamPartStatus> types = examPartStatusServiceInterface.findAll();
//		
...
//		ExamPartStatus t = examPartStatusServiceInterface.findOne(id);
//		if(t == null) {
...
//		ExamPartStatus t = examPartStatusServiceInterface.findOne(dto.getId());
//		
//		if(t == null) {
//			return new ResponseEntity<ExamPartStatusDTO>(HttpStatus.NOT_FOUND);
//		}
...
//		t = examPartStatusServiceInterface.save(t);
//		return new ResponseEntity<ExamPartStatusDTO>(new ExamPartStatusDTO(t), HttpStatus.OK);
//	}
//	
//	@PostMapping
...
//		
//		if(t != null) {
//			examPartStatusServiceInterface.delete(id);
